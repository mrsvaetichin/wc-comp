...
insert into matches (id,stage,grp,md,home,away,kickoff,home_score,away_score,status) values ('ko-r16-6','r16',null,5,'D1','G1','2026-07-06T17:00:00-04:00',null,null,'scheduled') on conflict (id) do update set kickoff=excluded.kickoff, md=excluded.md, home=excluded.home, away=excluded.away, stage=excluded.stage;
