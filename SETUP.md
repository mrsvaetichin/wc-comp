...
- **💬 Banter bonus:** Every ❤️ like you receive on a banter post is **+1 point** toward your main standings. No podium thresholds, no "top 3 only" — like in, point out. Get 20 likes → +20 pts. The Banter board shows everyone's running ❤️ count (which is also their banter points contribution), and the 💬 Banter race chart on the dashboard tracks the same thing as a live line graph.
